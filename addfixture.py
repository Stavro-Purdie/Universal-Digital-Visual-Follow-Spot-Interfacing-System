...
def fixturesetup():
    with open('fixtureprofiles.json', 'r') as file:         # Read JSON file
    ...
    fixturecount = int(input('Enter how many fixture profiles you want to add to the system >> '))
    i = 1
...
if __name__ == "__main__":                                          ##Only Allow file to be ran manually (to be removed)
    fixturesetup()